...
tuple_type
    : FM_ImplicitToken5  (fm_tuple_element | tuple_element) (FM_ImplicitToken6  (fm_tuple_element | tuple_element))+ FM_ImplicitToken7 
    ;
...
type_argument_list 
	: FM_ImplicitToken8  (fm_type_ | type_) ( FM_ImplicitToken9  (fm_type_ | type_))* FM_ImplicitToken10 
	;
...
//B.2.4 Expressions
argument_list 
	: (fm_argument | argument) ( FM_ImplicitToken11  (fm_argument | argument))*
	;
...
argument
	: ((fm_identifier | identifier) FM_ImplicitToken12 )? refout=(REF | OUT | IN)? (VAR | type_)? (fm_expression | expression)
	;
...
assignment
	...
	| (fm_unary_expression | unary_expression) FM_ImplicitToken13  (fm_throwable_expression | throwable_expression)
	;

assignment_operator
	: FM_ImplicitToken14  | FM_ImplicitToken15  | FM_ImplicitToken16  | FM_ImplicitToken17  | FM_ImplicitToken18  | FM_ImplicitToken19  | FM_ImplicitToken20  | FM_ImplicitToken21  | FM_ImplicitToken22  | FM_ImplicitToken23  | right_shift_assignment
	;
...
conditional_expression
	: (fm_null_coalescing_expression | null_coalescing_expression) (FM_ImplicitToken24  (fm_throwable_expression | throwable_expression) FM_ImplicitToken25  (fm_throwable_expression | throwable_expression))?
	;

null_coalescing_expression
	: (fm_conditional_or_expression | conditional_or_expression) (FM_ImplicitToken26  (null_coalescing_expression | throw_expression))?
	;
...
inclusive_or_expression
	: (fm_exclusive_or_expression | exclusive_or_expression) (FM_ImplicitToken27  (fm_exclusive_or_expression | exclusive_or_expression))*
	;
...
exclusive_or_expression
	: (fm_and_expression | and_expression) (FM_ImplicitToken28  (fm_and_expression | and_expression))*
	;
...
and_expression
	: (fm_equality_expression | equality_expression) (FM_ImplicitToken29  (fm_equality_expression | equality_expression))*
	;
...
relational_expression
	: (fm_shift_expression | shift_expression) ((FM_ImplicitToken30  | FM_ImplicitToken31  | FM_ImplicitToken32  | FM_ImplicitToken33 ) (fm_shift_expression | shift_expression) | IS (fm_isType | isType) | AS (fm_type_ | type_))*
	;
...
shift_expression
	: (fm_additive_expression | additive_expression) ((FM_ImplicitToken34  | right_shift)  (fm_additive_expression | additive_expression))*
	;
...
additive_expression
	: (fm_multiplicative_expression | multiplicative_expression) ((FM_ImplicitToken35  | FM_ImplicitToken36 )  (fm_multiplicative_expression | multiplicative_expression))*
	;
...
multiplicative_expression
	: (fm_switch_expression | switch_expression) ((FM_ImplicitToken37  | FM_ImplicitToken38  | FM_ImplicitToken39 )  (fm_switch_expression | switch_expression))*
	;
...
switch_expression
    : (fm_range_expression | range_expression) (FM_ImplicitToken40  FM_ImplicitToken41  ((fm_switch_expression_arms | switch_expression_arms) FM_ImplicitToken42 ?)? FM_ImplicitToken43 )?
    ;
...
switch_expression_arms
    : (fm_switch_expression_arm | switch_expression_arm) (FM_ImplicitToken44  (fm_switch_expression_arm | switch_expression_arm))*
    ;
...
unary_expression
	: primary_expression
	| FM_ImplicitToken45  (fm_unary_expression | unary_expression)
	| FM_ImplicitToken46  (fm_unary_expression | unary_expression)
	| BANG (fm_unary_expression | unary_expression)
	| FM_ImplicitToken47  (fm_unary_expression | unary_expression)
	| FM_ImplicitToken48  (fm_unary_expression | unary_expression)
	| FM_ImplicitToken49  (fm_unary_expression | unary_expression)
	...
	| FM_ImplicitToken50  (fm_unary_expression | unary_expression)
	| FM_ImplicitToken51  (fm_unary_expression | unary_expression)
	| FM_ImplicitToken52  (fm_unary_expression | unary_expression) // C# 8 ranges
	;
...
primary_expression  // Null-conditional operators C# 6: https://msdn.microsoft.com/en-us/library/dn986595.aspx
	: (fm_primary_expression_start | primary_expression_start) FM_ImplicitToken53 ? (fm_bracket_expressionStar | bracket_expression)* FM_ImplicitToken54 ?
	  (((member_access | method_invocation | FM_ImplicitToken55  | FM_ImplicitToken56  | FM_ImplicitToken57  (fm_identifier | identifier)) FM_ImplicitToken58 ?) (fm_bracket_expressionStar | bracket_expression)* FM_ImplicitToken59 ?)*
	;
...
primary_expression_start
	...
	| BASE (FM_ImplicitToken60  (fm_identifier | identifier) (fm_type_argument_listOpt | type_argument_list)? | FM_ImplicitToken61  (fm_expression_list | expression_list) FM_ImplicitToken62 ) #baseAccessExpression
	| NEW ((fm_type_ | type_) (object_creation_expression
	             | object_or_collection_initializer
	             | FM_ImplicitToken63  (fm_expression_list | expression_list) FM_ImplicitToken64  (fm_rank_specifierStar | rank_specifier)* (fm_array_initializerOpt | array_initializer)?
	...
	| OPEN_PARENS (fm_argument | argument) ( FM_ImplicitToken65  (fm_argument | argument) )+ CLOSE_PARENS           #tupleExpression
	...
	| NAMEOF OPEN_PARENS ((fm_identifier | identifier) FM_ImplicitToken66 )* (fm_identifier | identifier) CLOSE_PARENS  #nameofExpression
	;
...
member_access
	: FM_ImplicitToken67 ? FM_ImplicitToken68  (fm_identifier | identifier) (fm_type_argument_listOpt | type_argument_list)?
	;

bracket_expression
	: FM_ImplicitToken69 ? FM_ImplicitToken70  (fm_indexer_argument | indexer_argument) ( FM_ImplicitToken71  (fm_indexer_argument | indexer_argument))* FM_ImplicitToken72 
	;
...
indexer_argument
	: ((fm_identifier | identifier) FM_ImplicitToken73 )? (fm_expression | expression)
	;
...
expression_list
	: (fm_expression | expression) (FM_ImplicitToken74  (fm_expression | expression))*
	;
...
object_initializer
	: OPEN_BRACE ((fm_member_initializer_list | member_initializer_list) FM_ImplicitToken75 ?)? CLOSE_BRACE
	;

member_initializer_list
	: (fm_member_initializer | member_initializer) (FM_ImplicitToken76  (fm_member_initializer | member_initializer))*
	;
...
member_initializer
	: (identifier | FM_ImplicitToken77  (fm_expression | expression) FM_ImplicitToken78 ) FM_ImplicitToken79  (fm_initializer_value | initializer_value) // C# 6
	;
...
collection_initializer
	: OPEN_BRACE (fm_element_initializer | element_initializer) (FM_ImplicitToken80  (fm_element_initializer | element_initializer))* FM_ImplicitToken81 ? CLOSE_BRACE
	;
...
anonymous_object_initializer
	: OPEN_BRACE ((fm_member_declarator_list | member_declarator_list) FM_ImplicitToken82 ?)? CLOSE_BRACE
	;

member_declarator_list
	: (fm_member_declarator | member_declarator) ( FM_ImplicitToken83  (fm_member_declarator | member_declarator))*
	;
...
member_declarator
	: primary_expression
	| (fm_identifier | identifier) FM_ImplicitToken84  (fm_expression | expression)
	;
...
unbound_type_name
	: (fm_identifier | identifier) ( (fm_generic_dimension_specifierOpt | generic_dimension_specifier)? | FM_ImplicitToken85  (fm_identifier | identifier) (fm_generic_dimension_specifierOpt | generic_dimension_specifier)?)
	  (FM_ImplicitToken86  (fm_identifier | identifier) (fm_generic_dimension_specifierOpt | generic_dimension_specifier)?)*
	;

generic_dimension_specifier
	: FM_ImplicitToken87  FM_ImplicitToken88 * FM_ImplicitToken89 
	;
...
isType
	: (fm_base_type | base_type) (rank_specifier | FM_ImplicitToken90 )* FM_ImplicitToken91 ? (fm_isTypePatternArmsOpt | isTypePatternArms)? (fm_identifierOpt | identifier)?
	;
fm_isType: FM_PLACEHOLDER | FM_IF (fm_isType | isType) (FM_ELSE_IF (fm_isType | isType))* FM_ELSE (fm_isType | isType) FM_IF_CLOSE;

isTypePatternArms
	: FM_ImplicitToken92  (fm_isTypePatternArm | isTypePatternArm) (FM_ImplicitToken93  (fm_isTypePatternArm | isTypePatternArm))* FM_ImplicitToken94 
	;
...
isTypePatternArm
	: (fm_identifier | identifier) FM_ImplicitToken95  (fm_expression | expression)
	;
...
explicit_anonymous_function_parameter_list
	: (fm_explicit_anonymous_function_parameter | explicit_anonymous_function_parameter) ( FM_ImplicitToken96  (fm_explicit_anonymous_function_parameter | explicit_anonymous_function_parameter))*
	;
...
implicit_anonymous_function_parameter_list
	: (fm_identifier | identifier) (FM_ImplicitToken97  (fm_identifier | identifier))*
	;
...
let_clause
	: LET (fm_identifier | identifier) FM_ImplicitToken98  (fm_expression | expression)
	;
...
orderby_clause
	: ORDERBY (fm_ordering | ordering) (FM_ImplicitToken99   (fm_ordering | ordering))*
	;
...
declarationStatement
	: (fm_local_variable_declaration | local_variable_declaration) FM_ImplicitToken100 
	| (fm_local_constant_declaration | local_constant_declaration) FM_ImplicitToken101 
...
local_function_body
    : block
    | (fm_right_arrow | right_arrow) (fm_throwable_expression | throwable_expression) FM_ImplicitToken102 
    ;
...
labeled_Statement
	: (fm_identifier | identifier) FM_ImplicitToken103  (fm_statement | statement)  
	;
...
simple_embedded_statement
	: FM_ImplicitToken104                                                          #theEmptyStatement
	| (fm_expression | expression) FM_ImplicitToken105                                               #expressionStatement
	...
	| DO (fm_embedded_statement | embedded_statement) WHILE OPEN_PARENS (fm_expression | expression) CLOSE_PARENS FM_ImplicitToken106                                  #doStatement
	| FOR OPEN_PARENS (fm_for_initializerOpt | for_initializer)? FM_ImplicitToken107  (fm_expressionOpt | expression)? FM_ImplicitToken108  (fm_for_iteratorOpt | for_iterator)? CLOSE_PARENS (fm_embedded_statement | embedded_statement)  #forStatement
    ...
    // jump statements
	| BREAK FM_ImplicitToken109                                                    #breakStatement
	| CONTINUE FM_ImplicitToken110                                                 #continueStatement
	| GOTO (identifier | CASE (fm_expression | expression) | DEFAULT) FM_ImplicitToken111            #gotoStatement
	| RETURN (fm_expressionOpt | expression)? FM_ImplicitToken112                                       #returnStatement
	| THROW (fm_expressionOpt | expression)? FM_ImplicitToken113                                        #throwStatement
	...
	| YIELD (RETURN (fm_expression | expression) | BREAK) FM_ImplicitToken114                        #yieldStatement
...
local_variable_declaration
	: (USING | REF | REF READONLY)? (fm_local_variable_type | local_variable_type) (fm_local_variable_declarator | local_variable_declarator) ( FM_ImplicitToken115   (fm_local_variable_declarator | local_variable_declarator) { this.IsLocalVariableDeclaration() }? )*
...
local_variable_declarator
	: (fm_identifier | identifier) (FM_ImplicitToken116  REF? (fm_local_variable_initializer | local_variable_initializer) )?
	;
...
switch_label
	: CASE (fm_expression | expression) (fm_case_guardOpt | case_guard)? FM_ImplicitToken117 
	| DEFAULT FM_ImplicitToken118 
	;
...
for_initializer
	: local_variable_declaration
	| (fm_expression | expression) (FM_ImplicitToken119   (fm_expression | expression))*
	;
...
for_iterator
	: (fm_expression | expression) (FM_ImplicitToken120   (fm_expression | expression))*
	;
...
namespace_declaration
	: NAMESPACE (fm_qualified_identifier | qualified_identifier) (fm_namespace_body | namespace_body) FM_ImplicitToken121 ?
	;

qualified_identifier
	: (fm_identifier | identifier) ( FM_ImplicitToken122   (fm_identifier | identifier) )*
	;
...
extern_alias_directive
	: EXTERN ALIAS (fm_identifier | identifier) FM_ImplicitToken123 
	;
...
using_directive
	: USING (fm_identifier | identifier) FM_ImplicitToken124  (fm_namespace_or_type_name | namespace_or_type_name) FM_ImplicitToken125             #usingAliasDirective
	| USING (fm_namespace_or_type_name | namespace_or_type_name) FM_ImplicitToken126                            #usingNamespaceDirective
	// C# 6: https://msdn.microsoft.com/en-us/library/ms228593.aspx
	| USING STATIC (fm_namespace_or_type_name | namespace_or_type_name) FM_ImplicitToken127                     #usingStaticDirective
	;
...
qualified_alias_member
	: (fm_identifier | identifier) FM_ImplicitToken128  (fm_identifier | identifier) (fm_type_argument_listOpt | type_argument_list)?
	;

//B.2.7 Classes;
type_parameter_list
	: FM_ImplicitToken129  (fm_type_parameter | type_parameter) (FM_ImplicitToken130   (fm_type_parameter | type_parameter))* FM_ImplicitToken131 
	;
...
class_base
	: FM_ImplicitToken132  (fm_class_type | class_type) (FM_ImplicitToken133   (fm_namespace_or_type_name | namespace_or_type_name))*
	;
...
interface_type_list
	: (fm_namespace_or_type_name | namespace_or_type_name) (FM_ImplicitToken134   (fm_namespace_or_type_name | namespace_or_type_name))*
	;
...
type_parameter_constraints_clause
	: WHERE (fm_identifier | identifier) FM_ImplicitToken135  (fm_type_parameter_constraints | type_parameter_constraints)
	;
...
type_parameter_constraints
	...
	| (fm_primary_constraint | primary_constraint) (FM_ImplicitToken136  (fm_secondary_constraints | secondary_constraints))? (FM_ImplicitToken137  (fm_constructor_constraint | constructor_constraint))?
	;
...
secondary_constraints
	: (fm_namespace_or_type_name | namespace_or_type_name) (FM_ImplicitToken139  (fm_namespace_or_type_name | namespace_or_type_name))*
	;
...
common_member_declaration
	...
	| event_declaration
	| (fm_conversion_operator_declarator | conversion_operator_declarator) (body | (fm_right_arrow | right_arrow) (fm_throwable_expression | throwable_expression) FM_ImplicitToken140 ) // C# 6
...
typed_member_declaration
	: (REF | READONLY REF | REF READONLY)? (fm_type_ | type_)
	  ( (fm_namespace_or_type_name | namespace_or_type_name) FM_ImplicitToken141  (fm_indexer_declaration | indexer_declaration)
	  | method_declaration
...
constant_declarators
	: (fm_constant_declarator | constant_declarator) (FM_ImplicitToken142   (fm_constant_declarator | constant_declarator))*
	;
...
constant_declarator
	: (fm_identifier | identifier) FM_ImplicitToken143  (fm_expression | expression)
	;
...
variable_declarators
	: (fm_variable_declarator | variable_declarator) (FM_ImplicitToken144   (fm_variable_declarator | variable_declarator))*
	;
...
variable_declarator
	: (fm_identifier | identifier) (FM_ImplicitToken145  (fm_variable_initializer | variable_initializer))?
	;
...
formal_parameter_list
	: parameter_array
	| (fm_fixed_parameters | fixed_parameters) (FM_ImplicitToken147  (fm_parameter_array | parameter_array))?
	;
...
fixed_parameters
	: (fm_fixed_parameter | fixed_parameter) ( FM_ImplicitToken148  (fm_fixed_parameter | fixed_parameter) )*
	;
...
constructor_initializer
	: FM_ImplicitToken166  (BASE | THIS) OPEN_PARENS (fm_argument_listOpt | argument_list)? CLOSE_PARENS
	;
...
//B.2.8 Structs
struct_interfaces
	: FM_ImplicitToken168  (fm_interface_type_list | interface_type_list)
	;
...
struct_member_declaration
	: (fm_attributesOpt | attributes)? (fm_all_member_modifiersOpt | all_member_modifiers)?
	  (common_member_declaration | FIXED (fm_type_ | type_) (fm_fixed_size_buffer_declaratorPlus | fixed_size_buffer_declarator)+ FM_ImplicitToken169 )
	;
...
//B.2.9 Arrays
array_type
	: (fm_base_type | base_type) ((FM_ImplicitToken170  | FM_ImplicitToken171 )* (fm_rank_specifier | rank_specifier))+
	;
...
rank_specifier
	: FM_ImplicitToken172  FM_ImplicitToken173 * FM_ImplicitToken174 
	;
...
array_initializer
	: OPEN_BRACE ((fm_variable_initializer | variable_initializer) (FM_ImplicitToken175   (fm_variable_initializer | variable_initializer))* FM_ImplicitToken176 ?)? CLOSE_BRACE
	;
...
variant_type_parameter_list
	: FM_ImplicitToken177  (fm_variant_type_parameter | variant_type_parameter) (FM_ImplicitToken178  (fm_variant_type_parameter | variant_type_parameter))* FM_ImplicitToken179 
	;
...
interface_base
	: FM_ImplicitToken180  (fm_interface_type_list | interface_type_list)
	;
...
interface_member_declaration
	: (fm_attributesOpt | attributes)? NEW?
	  (UNSAFE? (REF | REF READONLY | READONLY REF)? (fm_type_ | type_)
	    ( (fm_identifier | identifier) (fm_type_parameter_listOpt | type_parameter_list)? OPEN_PARENS (fm_formal_parameter_listOpt | formal_parameter_list)? CLOSE_PARENS (fm_type_parameter_constraints_clausesOpt | type_parameter_constraints_clauses)? FM_ImplicitToken181 
	    | (fm_identifier | identifier) OPEN_BRACE (fm_interface_accessors | interface_accessors) CLOSE_BRACE
	    | THIS FM_ImplicitToken182  (fm_formal_parameter_list | formal_parameter_list) FM_ImplicitToken183  OPEN_BRACE (fm_interface_accessors | interface_accessors) CLOSE_BRACE)
	  | UNSAFE? VOID (fm_identifier | identifier) (fm_type_parameter_listOpt | type_parameter_list)? OPEN_PARENS (fm_formal_parameter_listOpt | formal_parameter_list)? CLOSE_PARENS (fm_type_parameter_constraints_clausesOpt | type_parameter_constraints_clauses)? FM_ImplicitToken184 
	  | EVENT (fm_type_ | type_) (fm_identifier | identifier) FM_ImplicitToken185 )
	;
...
interface_accessors
	: (fm_attributesOpt | attributes)? (GET FM_ImplicitToken186  ((fm_attributesOpt | attributes)? SET FM_ImplicitToken187 )? | SET FM_ImplicitToken188  ((fm_attributesOpt | attributes)? GET FM_ImplicitToken189 )?)
	;
...
//B.2.11 Enums
enum_base
	: FM_ImplicitToken190  (fm_type_ | type_)
	;
...
enum_body
	: OPEN_BRACE ((fm_enum_member_declaration | enum_member_declaration) (FM_ImplicitToken191   (fm_enum_member_declaration | enum_member_declaration))* FM_ImplicitToken192 ?)? CLOSE_BRACE
	;
...
enum_member_declaration
	: (fm_attributesOpt | attributes)? (fm_identifier | identifier) (FM_ImplicitToken193  (fm_expression | expression))?
	;
...
global_attribute_section
	: FM_ImplicitToken194  (fm_global_attribute_target | global_attribute_target) FM_ImplicitToken195  (fm_attribute_list | attribute_list) FM_ImplicitToken196 ? FM_ImplicitToken197 
	;
...
attribute_section
	: FM_ImplicitToken198  ((fm_attribute_target | attribute_target) FM_ImplicitToken199 )? (fm_attribute_list | attribute_list) FM_ImplicitToken200 ? FM_ImplicitToken201 
	;
...
attribute_list
	: (fm_attribute | attribute) (FM_ImplicitToken202   (fm_attribute | attribute))*
	;
...
attribute
	: (fm_namespace_or_type_name | namespace_or_type_name) (OPEN_PARENS ((fm_attribute_argument | attribute_argument) (FM_ImplicitToken203   (fm_attribute_argument | attribute_argument))*)? CLOSE_PARENS)?
	;
...
attribute_argument
	: ((fm_identifier | identifier) FM_ImplicitToken204 )? (fm_expression | expression)
	;
...
pointer_type
	: (simple_type | class_type) (rank_specifier | FM_ImplicitToken205 )* FM_ImplicitToken206 
	| VOID FM_ImplicitToken207 
	;
...
fixed_pointer_declarators
	: (fm_fixed_pointer_declarator | fixed_pointer_declarator) (FM_ImplicitToken208   (fm_fixed_pointer_declarator | fixed_pointer_declarator))*
	;
...
fixed_pointer_declarator
	: (fm_identifier | identifier) FM_ImplicitToken209  (fm_fixed_pointer_initializer | fixed_pointer_initializer)
	;
...
fixed_pointer_initializer
	: FM_ImplicitToken210 ? (fm_expression | expression)
	| stackalloc_initializer
	;
...
fixed_size_buffer_declarator
	: (fm_identifier | identifier) FM_ImplicitToken211  (fm_expression | expression) FM_ImplicitToken212 
	;
...
stackalloc_initializer
	: STACKALLOC (fm_type_ | type_) FM_ImplicitToken213  (fm_expression | expression) FM_ImplicitToken214 
	| STACKALLOC (fm_type_Opt | type_)? FM_ImplicitToken215  (fm_expressionOpt | expression)? FM_ImplicitToken216  OPEN_BRACE (fm_expression | expression) (FM_ImplicitToken217  (fm_expression | expression))* FM_ImplicitToken218 ? CLOSE_BRACE
	;

right_arrow
	: first=FM_ImplicitToken219  second=FM_ImplicitToken220  {$first.index + 1 == $second.index}? // Nothing between the tokens?
	;
...
right_shift
	: first=FM_ImplicitToken221  second=FM_ImplicitToken222  {$first.index + 1 == $second.index}? // Nothing between the tokens?
	;

right_shift_assignment
	: first=FM_ImplicitToken223  second=FM_ImplicitToken224  {$first.index + 1 == $second.index}? // Nothing between the tokens?
	;
...
interpolated_string_expression
	: (fm_expression | expression) (FM_ImplicitToken225  (fm_expression | expression))* (FM_ImplicitToken226  FORMAT_STRING+)?
	;
...
class_definition
	: CLASS (fm_identifier | identifier) (fm_type_parameter_listOpt | type_parameter_list)? (fm_class_baseOpt | class_base)? (fm_type_parameter_constraints_clausesOpt | type_parameter_constraints_clauses)?
	    (fm_class_body | class_body) FM_ImplicitToken227 ?
	;
...
struct_definition
	: (READONLY | REF)? STRUCT (fm_identifier | identifier) (fm_type_parameter_listOpt | type_parameter_list)? (fm_struct_interfacesOpt | struct_interfaces)? (fm_type_parameter_constraints_clausesOpt | type_parameter_constraints_clauses)?
	    (fm_struct_body | struct_body) FM_ImplicitToken228 ?
	;
...
interface_definition
	: INTERFACE (fm_identifier | identifier) (fm_variant_type_parameter_listOpt | variant_type_parameter_list)? (fm_interface_baseOpt | interface_base)?
	    (fm_type_parameter_constraints_clausesOpt | type_parameter_constraints_clauses)? (fm_class_body | class_body) FM_ImplicitToken229 ?
	;

enum_definition
	: ENUM (fm_identifier | identifier) (fm_enum_baseOpt | enum_base)? (fm_enum_body | enum_body) FM_ImplicitToken230 ?
	;
...
delegate_definition
	: DELEGATE (fm_return_type | return_type) (fm_identifier | identifier) (fm_variant_type_parameter_listOpt | variant_type_parameter_list)?
	  OPEN_PARENS (fm_formal_parameter_listOpt | formal_parameter_list)? CLOSE_PARENS (fm_type_parameter_constraints_clausesOpt | type_parameter_constraints_clauses)? FM_ImplicitToken231 
	;

event_declaration
	: EVENT (fm_type_ | type_) ((fm_variable_declarators | variable_declarators) FM_ImplicitToken232  | (fm_member_name | member_name) OPEN_BRACE (fm_event_accessor_declarations | event_accessor_declarations) CLOSE_BRACE)
	;

field_declaration
	: (fm_variable_declarators | variable_declarators) FM_ImplicitToken233 
	;

property_declaration // Property initializer & lambda in properties C# 6
	: (fm_member_name | member_name) (OPEN_BRACE (fm_accessor_declarations | accessor_declarations) CLOSE_BRACE (FM_ImplicitToken234  (fm_variable_initializer | variable_initializer) FM_ImplicitToken235 )? | (fm_right_arrow | right_arrow) (fm_throwable_expression | throwable_expression) FM_ImplicitToken236 )
	;

constant_declaration
	: CONST (fm_type_ | type_) (fm_constant_declarators | constant_declarators) FM_ImplicitToken237 
	;

indexer_declaration // lamdas from C# 6
	: THIS FM_ImplicitToken238  (fm_formal_parameter_list | formal_parameter_list) FM_ImplicitToken239  (OPEN_BRACE (fm_accessor_declarations | accessor_declarations) CLOSE_BRACE | (fm_right_arrow | right_arrow) (fm_throwable_expression | throwable_expression) FM_ImplicitToken240 )
	;
...
destructor_definition
	: FM_ImplicitToken241  (fm_identifier | identifier) OPEN_PARENS CLOSE_PARENS (fm_body | body)
	;
...
method_declaration // lamdas from C# 6
	: (fm_method_member_name | method_member_name) (fm_type_parameter_listOpt | type_parameter_list)? OPEN_PARENS (fm_formal_parameter_listOpt | formal_parameter_list)? CLOSE_PARENS
	    (fm_type_parameter_constraints_clausesOpt | type_parameter_constraints_clauses)? (method_body | (fm_right_arrow | right_arrow) (fm_throwable_expression | throwable_expression) FM_ImplicitToken242 )
	;
...
method_member_name
	: (identifier | (fm_identifier | identifier) FM_ImplicitToken243  (fm_identifier | identifier)) ((fm_type_argument_listOpt | type_argument_list)? FM_ImplicitToken244  (fm_identifier | identifier))*
	;
...
operator_declaration // lamdas form C# 6
	: OPERATOR (fm_overloadable_operator | overloadable_operator) OPEN_PARENS IN? (fm_arg_declaration | arg_declaration)
	       (FM_ImplicitToken245  IN? (fm_arg_declaration | arg_declaration))? CLOSE_PARENS (body | (fm_right_arrow | right_arrow) (fm_throwable_expression | throwable_expression) FM_ImplicitToken246 )
	;

arg_declaration
	: (fm_type_ | type_) (fm_identifier | identifier) (FM_ImplicitToken247  (fm_expression | expression))?
	;
