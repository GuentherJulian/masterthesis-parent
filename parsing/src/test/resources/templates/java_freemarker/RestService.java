...
public interface ${variables.component?cap_first + 'RestService'} {
  ...
  /**
  * Delegates to {@link ${variables.component?cap_first}#${'f' + 'i' + 'n' + 'd' + variables.entityName}}.
  *
  ...
  */
  ...
  public ${variables.entityName + 'Eto'} ${'g' + 'e' + 't' + variables.entityName}(@PathParam("id") <#if compositeIdTypeVar!="null"> ${compositeIdTypeVar} <#else> long </#if> id);

  /**
   * Delegates to {@link ${variables.component?cap_first}#${'s' + 'a' + 'v' + 'e' + variables.entityName}}.
   *
  ...
  public ${variables.entityName + 'Eto'} ${'s' + 'a' + 'v' + 'e' + variables.entityName}(${variables.entityName + 'Eto'} ${variables.entityName?lower_case});


  /**
   * Delegates to {@link ${variables.component?cap_first}#${'d' + 'e' + 'l' + 'e' + 't' + 'e' + variables.entityName}}.
   *
   * @param id ID of the {@link ${variables.entityName + 'Eto'}} to be deleted
   */
  @DELETE
  @Path(${'/' + variables.entityName?lower_case + '/{id}/'})
  public void ${'d' + 'e' + 'l' + 'e' + 't' + 'e' + variables.entityName}(@PathParam("id") <#if compositeIdTypeVar!="null"> ${compositeIdTypeVar} <#else> long </#if> id);

  /**
   * Delegates to {@link ${variables.component?cap_first}#${'f' + 'i' + 'n' + 'd' + variables.entityName + 'Etos'}}.
   *
  ...
  @POST
  public Page<${variables.entityName + 'Eto'}> ${'f' + 'i' + 'n' + 'd' + variables.entityName + 's'}(${variables.entityName + 'SearchCriteriaTo'} searchCriteriaTo);
