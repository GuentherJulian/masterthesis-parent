...
public class Java8FreemarkerTemplateGrammarParserTest extends AbstractParserTest {
	...
	@Test
	void java8RealTemplateTest1() throws Exception {
		Path inputFile = testResourcesPath.resolve("templates/java_freemarker/ServiceConfig.java");
	...
	@Test
	void java8RestServiceTest() throws Exception {
		Path inputFile = testResourcesPath.resolve("templates/java_freemarker/RestService.java");
	...
	@Test
	void java8ImplementsUnparseableTest() throws Exception {
		Path inputFile = testResourcesPath.resolve("templates/java_freemarker/ImplementsUnparseable.java");
